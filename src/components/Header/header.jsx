      ...
      <section className="text-start">
        ...
        <Slide delay={150} direction="left">
          <p className="color-parrafo fw-parrafo">
            Construyo aplicaciones digitales escalables y atractivas desde el
            punto de vista del diseño y la funcionalidad.
          </p>
        </Slide>
        ...
        <Fade delay={400}>
          <section className="pt-3">
            ...
            >
              <a
                href="./CV Leandro Florentin Full Stack Developer 2024.pdf"
                download
              >
