...
const Header = ({ scrollToRef, sobreMiRef, habilidadesRef, experienciaRef, proyectosRef, contactosRef, activate, setActivate }) => {
  return (
    <header className="h-auto row overflow-hidden">
      <section className="text-start">
        ...
        <div className="col-12 pt-5 pb-5 d-lg-block d-none">
          <NavBar activate={activate} setActivate={setActivate} scrollToRef={scrollToRef} sobreMiRef={sobreMiRef} habilidadesRef={habilidadesRef} experienciaRef={experienciaRef} proyectosRef={proyectosRef} contactosRef={contactosRef} />
        </div>
        <Fade delay={400}>
          <section className="pt-3">
            ...
            <span className="d-inline-block" tabIndex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Disabled popover">
              <a href="./CV_Leandro_Florentin_2025.pdf" download>
