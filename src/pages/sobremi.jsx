const Sobremi = ({ reference }) => {
  return (
    <section ref={reference} id="sobre-mi" className="bottom-6rem top-6rem h-100">
      ...
      <hr />
      <p className="color-parrafo fw-parrafo">
        Me principal enfoque es el de crear aplicaciones Full Stack utilizando React para el diseño web y Node.js (JavaScript y TypeScript) para construir
        servicios y APIs. Trabajo con MySQL y SQLite para las bases de datos. También me encargo de mantener y mejorar estas aplicaciones con
        el tiempo. Utilizo Swagger para documentar mis APIs y Jenkins para automatizar los despliegues en AWS (EC2, S3, CloudFront).
      </p>
      <hr />
      <p className="color-parrafo fw-parrafo">
        Cuando no estoy frente a la computadora, generalmente estoy en el gimnasio, leyendo, pasando tiempo con mis gatos y perros, jugando fútbol o pádel.
      </p>
    </section>
  )
}
